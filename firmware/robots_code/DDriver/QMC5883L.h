#ifndef __IO_H
#define __IO_H 		
#define USING_QMC5883L		1
#include "math.h"
#include "stdbool.h"
#include "main.h"


#define IIC_SCL_PIN2 GPIO_PIN_0
#define IIC_SCL_PORT2 GPIOC

#define IIC_SDA_PIN2 GPIO_PIN_1
#define IIC_SDA_PORT2 GPIOC


//IIC_SDA	  PB11
#define IIC_SDA_OUT Soft_SDA_Output()
#define IIC_SDA_IN  Soft_SDA_Input()
#define IIC_SDA_SET HAL_GPIO_WritePin(IIC_SDA_PORT2,IIC_SDA_PIN2,GPIO_PIN_SET)
#define IIC_SDA_RESET HAL_GPIO_WritePin(IIC_SDA_PORT2,IIC_SDA_PIN2,GPIO_PIN_RESET)
#define IIC_SDA_State ((IIC_SDA_PORT2->IDR & 1<<1) == 1<<1)

//IIC_SCL	  PB12
#define IIC_SCL_OUT Soft_SCL_Output()
#define IIC_SCL_IN  Soft_SCL_Input()
#define IIC_SCL_SET HAL_GPIO_WritePin(IIC_SCL_PORT2,IIC_SCL_PIN2,GPIO_PIN_SET)
#define IIC_SCL_RESET  HAL_GPIO_WritePin(IIC_SCL_PORT2,IIC_SCL_PIN2,GPIO_PIN_RESET)
#define IIC_SCL_State ((IIC_SCL_PORT2->IDR & 1<<0) == 1<<0)
